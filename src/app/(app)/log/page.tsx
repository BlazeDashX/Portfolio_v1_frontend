...
import GapFillerBanner from '@/components/log/GapFillerBanner';
  ...
  return (
    <AppLayout>
      ...
      <div className="relative z-10 flex flex-col" style={{ height: 'calc(100vh - 56px)' }}>
        ...
        {/* Phase 3: Gap filler banners — today only */}
        {today && (
          <div className="shrink-0 px-5 pb-1">
            <GapFillerBanner dateStr={ds} onSelect={(task: any) => openModal(task)} />
          </div>
        )}
